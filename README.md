...
* [Домашнее задание 4](https://github.com/AnastasiyaMax/Python_DPO_2022/tree/main/hw_pandas) – задания на использование библиотек pandas, numpy (выдается после 15 занятия)
