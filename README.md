...
* [Домашнее задание 2](https://official.contest.yandex.ru/contest/29698/enter/) – структуры данных, циклы, функции (выдается после 5 занятия) – ИГНОРИРУЙТЕ УКАЗАННУЮ РАЗБАЛЛОВКУ
