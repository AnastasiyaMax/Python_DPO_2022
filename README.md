...
* *Домашнее задание Р – регулярные выражения (выдается после 5 занятия) – БОНУС (необязательно)*
* Домашнее задание 2 – структуры данных, циклы, функции (выдается после 5 занятия)
